...
def get_vgg16_lstm(filters, kernels, input_shape, activation='elu', dr=0):
    model = Sequential()

    model.add(ConvLSTM2D(filters = 64, kernel_size = 5, dilation_rate = 2, padding= 'same',activation= 'tanh',
                   data_format = 'channels_last', input_shape=(None, 32, 64, 2)))
